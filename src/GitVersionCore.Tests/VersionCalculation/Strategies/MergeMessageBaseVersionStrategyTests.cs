...
namespace GitVersionCore.Tests.VersionCalculation.Strategies
{
    ...
    public class MergeMessageBaseVersionStrategyTests : TestBase
    {
        ...
        [TestCase("Finish Release-0.12.0", true, "0.12.0")] //Support Syntevo SmartGit/Hg's Gitflow merge IGitCommit messages for finishing a 'Release' branch
        ...
        [TestCase("Merge IGitTag '10.10.50'", true)]
        ...
        [TestCase("Finish 0.14.1", true)] // Don't support Syntevo SmartGit/Hg's Gitflow merge IGitCommit messages for finishing a 'Hotfix' branch
...
* IGitCommit '38560a7eed06e8d3f3f1aaf091befcdf8bf50fea':
  Updated jQuery to v2.1.3")]
        [TestCase(@"Merge pull request #45 in BRIKKS/brikks from feature/NOX-68 to develop

* IGitCommit '38560a7eed06e8d3f3f1aaf091befcdf8bf50fea':
  Another IGitCommit message
  IGitCommit message including a IP-number https://10.50.1.1
  A IGitCommit message")]
        ...
        private void AssertMergeMessage(string message, string expectedVersion, List<IGitCommit> parents, Config config = null)
        {
            var IGitCommit = new MockCommit
            {
                MessageEx = message,
                ParentsEx = parents
            };
        ...
        private static List<IGitCommit> GetParents(bool isMergeCommit)
        {
            if (isMergeCommit)
            {
                return new List<IGitCommit>
                {
                    null,
                    null
                };
