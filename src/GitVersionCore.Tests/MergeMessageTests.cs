...
namespace GitVersionCore.Tests
{
    ...
    public class MergeMessageTests : TestBase
    {
        ...
        private static readonly object[] MergeMessages =
        {
            ...
            new object[] { "Merge IGitTag 'v4.0.0' into master", "v4.0.0", "master", new SemanticVersion(4) },
            new object[] { "Merge IGitTag 'V4.0.0' into master", "V4.0.0", "master", new SemanticVersion(4) },
            ...
            new object[] { "Merge IGitTag 'v://10.10.10.10' into master", "v://10.10.10.10", "master", null }
         };
        ...
        {
            // Arrange
            var format = @"^Merge (branch|IGitTag) '(?<SourceBranch>[^']*)'(?: into (?<TargetBranch>[^\s]*))*";
            var definition = "Mycustom";
            config.MergeMessageFormats = new Dictionary<string, string>
            {
                [definition] = format,
